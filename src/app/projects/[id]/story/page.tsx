          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              <div className="bg-zinc-50 dark:bg-zinc-800 rounded-lg p-4">
                <h3 className="font-medium text-zinc-900 dark:text-zinc-100 mb-2">角色</h3>
                <p className="text-sm text-zinc-500">0 个角色</p>
              </div>
              <div className="bg-zinc-50 dark:bg-zinc-800 rounded-lg p-4">
                <h3 className="font-medium text-zinc-900 dark:text-zinc-100 mb-2">场景</h3>
                <p className="text-sm text-zinc-500">0 个场景</p>
              </div>
              <div className="bg-zinc-50 dark:bg-zinc-800 rounded-lg p-4">
                <h3 className="font-medium text-zinc-900 dark:text-zinc-100 mb-2">道具</h3>
                <p className="text-sm text-zinc-500">0 个道具</p>
              </div>
            </div>
          </div>
